...
import { Button, ButtonPrimary, ButtonDisabled, FullInput } from '/imports/ui/Primitives'
    ...
    return (
        <Layout>
            ...
            <form onSubmit={(e) => {e.preventDefault()}}>
                ...
                <FullInput placeholder="Name" onChange={(e : any) => {setAuthorName(e.target.value)}} type="text" name="name" />
                <FullInput placeholder="E-Mail Adresse" onChange={(e : any) => {setAuthorEmail(e.target.value)}} type="email" name="email" />

                <h3>Titel des Events</h3>
                <FullInput onChange={(e : any) => {setTitle(e.target.value)}} placeholder="Titel" type="text" name="title" />

                <h3>Beschreibung des Events (optional)</h3>
                <FullInput onChange={(e : any) => {setDescription(e.target.value)}} placeholder="Beschreibung" type="text" name="description" />

                <h3>Virtueller Raum des Events</h3>
                <p>
                    (z.B. Telefonat, Google Hangouts, WhatsApp Konferenz, ...)
                </p>
                <FullInput onChange={(e : any) => {setSpace(e.target.value)}} placeholder="Virtueller Raum" type="text" name="space" />
                ...
                <div className="actions spread-horizontal">
                    ...
                    {formComplete() ? (
                        ...
                        }}>Event erstellen</ButtonDisabled>
                    )}
                </div>
            </form>
